...
<PullQuote cite="Post-mortem">The transaction did not have the lock on the user record inside it. The window between reading the balance and writing it back was long enough for a second request to slip through.</PullQuote>
